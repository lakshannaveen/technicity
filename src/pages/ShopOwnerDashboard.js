      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
            ...
            <div className="mt-2 flex items-center space-x-2">
              <input type="date" value={byDateInput} onChange={(e) => setByDateInput(e.target.value)} className="flex-1 border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500" />
              <button onClick={() => fetchBillsByDate(byDateInput)} className="px-4 py-2 bg-indigo-600 text-white rounded-lg text-sm font-medium hover:bg-indigo-700 transition-colors">
                Go
              </button>
            </div>
            <div className="mt-4 flex items-baseline justify-between">
